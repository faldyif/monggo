  ...
  <div class="social-profile">
    ...
    <div class="social-top">
      ...
      <div class="profile-left">
        <img src="img/profileimg.png" alt="img" class="profile-img">
        <h1 class="name">Jonathan Doe <a href="#" class="btn btn-success"><i class="fa fa-plus"></i>Add Friend</a></h1>
        ...
        <!-- Start Post -->
          <div class="panel panel-default">
            <div class="panel-body status">
              ...
              <div class="image"><img src="img/example1.jpg" alt="img"></div>
              <ul class="links">
                <li><a href="#"><i class="fa fa-thumbs-o-up"></i> Like</a></li>
                <li><a href="#"><i class="fa fa-comment-o"></i> Comment</a></li>
                <li><a href="#"><i class="fa fa-share-square-o"></i> Share</a></li>
        ...
        <!-- Start Post -->
          <div class="panel panel-default">
            <div class="panel-body status">
              ...
              <div class="who clearfix">
                <img src="img/profileimg5.png" alt="img">
                <span class="name"><b>John Doe</b> shared a post</span>
                <span class="from"><b>1 days ago</b> via Mobile, New York</span>
              </div>
              <div class="text">
        ...
        <!-- Start Post -->
          <div class="panel panel-default">
            <div class="panel-body status">
              ...
              <div class="who clearfix">
                <img src="img/profileimg6.png" alt="img">
